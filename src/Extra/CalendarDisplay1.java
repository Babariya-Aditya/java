...
/*
This program asks the user for a year and the day of the week that the year starts on,
 and then displays a calendar for that year on the console. It uses Zeller's congruence
 algorithm to calculate the day of the week for each day in the year and then prints
 out the calendar for each month of the year. The calendar includes the days of the
 week and the number of days in each month.
*/
import java.util.Scanner;

public class CalendarDisplay1{
    public static void main(String[] args) {
        ...
        for (int month = 1; month <= 12; month++) {
            ...
            for (int b = 0; b < 36 - (header.length() / 2); b++) {
                System.out.print(" ");
            }
